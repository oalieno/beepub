  ...
  <Popover.Trigger>
    <button
      ...
      class={variant === "text"
        ...
        : "flex h-10 items-center gap-2 rounded-full border border-input bg-card px-3 py-1 text-sm shadow-xs transition-[color,box-shadow] outline-none select-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] " +
